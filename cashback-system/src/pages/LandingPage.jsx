...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative">
      {/* CTA Sticky Mobile */}
      {showStickyCTA && (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t-2 border-primary-600 shadow-2xl p-4 lg:hidden animate-slideUp">
          <a 
            href="#planos"
            className="flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white px-6 py-4 rounded-xl font-bold text-base shadow-lg min-h-[56px] w-full"
          >
      ...
      <section className="relative bg-white text-gray-900 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-20">
          {/* Logo */}
          <div className="mb-4 md:mb-8 inline-block bg-white rounded-lg">
            <img 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-5 md:space-y-8">
              <div className="inline-block bg-primary-100 px-4 py-2 rounded-full text-sm font-semibold text-primary-700">
                ✨ 80% dos clientes nunca voltam. Mude isso!
              </div>
              ...
              <div className="space-y-3 bg-gray-50 p-6 rounded-xl border border-gray-200">
                <p className="flex items-center gap-3 text-lg text-gray-700">
                  ...
                  <span>Clientes compram 1x e desaparecem?</span>
                </p>
                <p className="flex items-center gap-3 text-lg text-gray-700">
                  <AlertCircle className="w-5 h-5 text-primary-600 flex-shrink-0" />
                  <span>Marketing sem resultado?</span>
                </p>
                <p className="flex items-center gap-3 text-lg text-gray-700">
                  <AlertCircle className="w-5 h-5 text-primary-600 flex-shrink-0" />
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 text-gray-900">
              <div className="text-center mb-4 md:mb-6">
                <div className="inline-block bg-green-100 text-green-800 px-3 md:px-4 py-2 rounded-full text-xs md:text-sm font-bold mb-3 md:mb-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-4 text-base border-2 border-gray-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all"
                ...
                <button
                  type="submit"
                  className="w-full bg-primary-600 hover:bg-primary-700 text-white px-6 py-4 rounded-lg font-bold text-base md:text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all min-h-[56px]"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
              O Custo de <span className="text-red-600">NÃO</span> Ter Fidelidade
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg text-center border-t-4 border-red-500">
              <div className="text-3xl md:text-4xl font-bold text-red-600 mb-1 md:mb-2">82%</div>
              <p className="text-sm md:text-base text-gray-700 font-semibold">clientes nunca voltam</p>
              <p className="text-xs md:text-sm text-gray-500 mt-1 md:mt-2">sem fidelidade</p>
            </div>

            <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg text-center border-t-4 border-orange-500">
              <div className="text-3xl md:text-4xl font-bold text-orange-600 mb-1 md:mb-2">5x</div>
              <p className="text-sm md:text-base text-gray-700 font-semibold">conquistar novo cliente</p>
              <p className="text-xs md:text-sm text-gray-500 mt-1 md:mt-2">vs. reter existente</p>
            </div>

            <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg text-center border-t-4 border-yellow-500">
              <div className="text-3xl md:text-4xl font-bold text-yellow-600 mb-1 md:mb-2">65%</div>
              <p className="text-sm md:text-base text-gray-700 font-semibold">vendas de clientes fiéis</p>
              <p className="text-xs md:text-sm text-gray-500 mt-1 md:mt-2">que voltam sempre</p>
            </div>

            <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg text-center border-t-4 border-green-500">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-1 md:mb-2">+40%</div>
              <p className="text-sm md:text-base text-gray-700 font-semibold">aumento faturamento</p>
              <p className="text-xs md:text-sm text-gray-500 mt-1 md:mt-2">com cashback ativo</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="como-funciona" className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            <div className="inline-block bg-primary-100 text-primary-800 px-3 md:px-4 py-2 rounded-full text-xs md:text-sm font-bold mb-3 md:mb-4">
              SIMPLES E RÁPIDO
            </div>
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
              Como Funciona em <span className="text-primary-600">3 Passos</span>
            </h2>
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Sistema funcionando em 24 horas
            </p>
          </div>
      ...
      <section id="planos" className="py-12 md:py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            <div className="inline-block bg-yellow-400 text-gray-900 px-3 md:px-4 py-2 rounded-full text-xs md:text-sm font-bold mb-3 md:mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto px-4">
            {/* Plano Starter */}
            <div className="bg-white text-gray-900 rounded-2xl shadow-2xl p-6 md:p-8 hover:scale-105 transition-transform">
              <div className="text-center mb-4 md:mb-6">
                <h3 className="text-xl md:text-2xl font-bold mb-2">Starter</h3>
                <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4">Começando agora</p>
                <div className="flex items-center justify-center gap-2">
                  <span className="text-3xl md:text-4xl font-bold text-primary-600">R$ 147</span>
                  <span className="text-sm md:text-base text-gray-600">/mês</span>
                </div>
                <p className="text-xs md:text-sm text-gray-500 mt-1 md:mt-2">ou R$ 1.470/ano (2 meses grátis)</p>
              </div>
            ...
            <div className="bg-gradient-to-br from-primary-600 to-primary-700 text-white rounded-2xl shadow-2xl p-6 md:p-8 transform md:scale-105 relative">
              <div className="absolute -top-3 md:-top-4 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-gray-900 px-4 md:px-6 py-1 rounded-full text-xs md:text-sm font-bold">
                MAIS POPULAR ⭐
              </div>
              
              <div className="text-center mb-4 md:mb-6 pt-3 md:pt-4">
                <h3 className="text-xl md:text-2xl font-bold mb-2">Business</h3>
                <p className="text-sm md:text-base text-primary-100 mb-3 md:mb-4">Crescer rápido</p>
                <div className="flex items-center justify-center gap-2">
                  <span className="text-3xl md:text-4xl font-bold">R$ 297</span>
                  <span className="text-sm md:text-base text-primary-100">/mês</span>
                </div>
                <p className="text-xs md:text-sm text-primary-200 mt-1 md:mt-2">ou R$ 2.970/ano (2 meses grátis)</p>
              </div>
            ...
            <div className="bg-white text-gray-900 rounded-2xl shadow-2xl p-6 md:p-8 hover:scale-105 transition-transform">
              <div className="text-center mb-4 md:mb-6">
                ...
                <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4">Dominar mercado</p>
                <div className="flex items-center justify-center gap-2">
                  <span className="text-3xl md:text-4xl font-bold text-primary-600">R$ 497</span>
                  <span className="text-sm md:text-base text-gray-600">/mês</span>
                </div>
                <p className="text-xs md:text-sm text-gray-500 mt-1 md:mt-2">ou R$ 4.970/ano (2 meses grátis)</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-base md:text-xl text-gray-600 px-4">
              Resultados reais de comércios locais
            </p>
          </div>
